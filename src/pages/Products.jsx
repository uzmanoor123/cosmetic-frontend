...
import { FiSearch, FiHeart, FiArrowLeft } from "react-icons/fi";
...
const Products = () => {
  ...
  const [search, setSearch] = useState(searchParams[0].get("search") || "");
      ...
      <div className="min-h-screen bg-[#f8f9fa]">
        <main className=" mx-auto px-8 py-8">
          ...
          <button
            ...
            className="flex items-center gap-2 text-pink-600 text-sm font-medium mb-6 hover:underline"
          >
            <FiArrowLeft />
            Back to Home
          </button>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-3 flex gap-3 mb-5 shadow-sm">
            ...
            <button className="bg-pink-600 hover:bg-pink-700 text-white px-5 rounded-lg text-sm font-semibold">
              Search
            </button>
          </div>

          <div className="grid grid-span-cols-1 lg:grid-cols-[310px_1fr] gap-5">
